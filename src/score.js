...
export const scoreSubjects = [
  {name:'基礎法学',score:2.4,max:8,average:2.8,percentile:73.1,color:'#8f7da8'},
  {name:'憲法',score:11.7,max:28,average:13.9,percentile:73.3,color:'#7b88aa'},
  {name:'民法',score:13.4,max:36,average:15.3,percentile:53.9,color:'#69a69a'},
  {name:'行政法',score:37.2,max:92,average:39.9,percentile:56.7,color:'#d59b49'},
  {name:'商法',score:6.4,max:20,average:6.8,percentile:45.3,color:'#a87666'},
  {name:'基礎知識',score:20.5,max:56,average:23.1,percentile:60.4,color:'#748178'}
]
